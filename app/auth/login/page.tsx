...
export default function LoginPage() {
    return <div className="lg:w-[800px] max-lg:max-w-[400px]  flex dark:bg-slate-950 bg-slate-100 w-full rounded-md">
        ...
        <div className="flex-1 p-8 dark:bg-[rgb(16,25,45)] dark:bg-opacity-100 border border-l-0 bg-slate-200 flex justify-center items-center max-lg:hidden">
            <KanbanSquareDashed size={80} />
        </div>
